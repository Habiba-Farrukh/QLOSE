...
public abstract class Statement extends SketchNode {
	...
	public String toString_Context(){
		if (this.postctx != null)
			return this.toString()+": "+this.postctx.toString();
		else
			return this.toString();
	}

	public abstract Context buildContext(Context postctx2, int scopePosition, List<Statement> originalStatements);

	public String getOriginalFunction() {
		return this.toString();
	}

	public abstract void addRecordStmtOriginal(StmtBlock parent, int i);
